          ...
          >
            <div className="relative">
              <img
                ...
                className={`h-10 w-10 sm:h-12 sm:w-12 object-contain transition-transform duration-300 group-hover:scale-105 ${dark ? 'brightness-0 invert' : ''}`}
              />
              <span className="absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 ring-2 ring-white/70 dark:ring-slate-900" />
            </div>
            <div className="leading-none text-left">
              ...
              <span
                className={`block text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.14em] mt-0.5 ${
