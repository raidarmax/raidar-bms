import { Bike, User, Building2, ChevronRight, ScanBarcode } from 'lucide-react';
      ...
      <div className="flex-1 max-w-5xl mx-auto w-full px-4 py-12 sm:py-20">
        ...
        <div className="mt-10 flex flex-col items-center">
          <div className="w-full max-w-md">
            <button
              onClick={() => onNavigate('field-register')}
              className="group w-full flex items-center gap-4 bg-gradient-to-r from-amber-50 to-orange-50 border-2 border-amber-200 hover:border-amber-400 rounded-2xl px-6 py-5 shadow-sm hover:shadow-lg transition-all duration-300"
            >
              <div className="bg-gradient-to-br from-amber-500 to-orange-600 rounded-xl w-12 h-12 flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform shadow-md">
                <ScanBarcode className="h-6 w-6 text-white" />
              </div>
              <div className="text-left flex-1">
                <h3 className="font-bold text-slate-900 text-base">Quick Register</h3>
                <p className="text-xs text-slate-500 mt-0.5">Scan a tracker barcode to register a motorcycle in under 60 seconds</p>
              </div>
