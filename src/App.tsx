...
type Page = 'home' | 'registration-choice' | 'register' | 'success' | 'verify' | 'report-incident' | 'admin' | 'admin-dashboard' | 'user-login' | 'user-dashboard' | 'rider-registration' | 'rider-login' | 'rider-dashboard' | 'police' | 'police-dashboard';
